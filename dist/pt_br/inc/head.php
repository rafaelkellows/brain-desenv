<?php
    $uToken = (!isset($_GET["t"]) ? 0 : $_GET["t"]);
    $submitReturn = (!isset($_GET["msg"]) ? -1 : $_GET["msg"]);
    
    if($uToken){
      header('location: ./valid.php?t='.$uToken);
    }
?>
<!DOCTYPE html>
<html lang="pt-br">
  <head>
    ...
    <link href="../css/styles_dev.css?v=201805062253" rel="stylesheet" media="screen" type='text/css'>
    <!-- endbuild-->

    <script type="text/javascript" src="../js/jquery-1.11.3.min.js"></script>
    <script src="../js/owl.carousel.min.js"></script>
    
    <script type='text/javascript' src='../js/scripts.js?v=201805062231'></script>
